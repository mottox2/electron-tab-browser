...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Tab, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      webview.addEventListener("dom-ready", function () {
	        ...
	        _this2.updateTab(webview.getTitle());
	      });

	      webview.addEventListener("new-window", function (e) {
	        console.log("new-window");
	        _this2.props.createTab(e.url);
	      });
	    }
	  }, {
	    key: 'updateTab',
	    value: function updateTab(title) {
	    ...
	    value: function render() {
	      return _react2.default.createElement('webview', { ref: 'webview', id: 'mainWebview', src: this.props.url, autosize: 'on', style: { 'display': this.props.visible ? 'block' : 'none' } });
	    }
	  }]);
	...
	var App = function (_Component2) {
	  ...
	  function App() {
	    ...
	    _this3.state = {
	      tabs: [{ url: "http://qiita.com", title: "" }, { url: "http://google.com", title: "" }, { url: "https://www.chatwork.com", title: "" }],
	      current: 0
	    };
	    return _this3;
	  }
	  ...
	  _createClass(App, [{
	    key: 'updateTab',
	    value: function updateTab(tab, index) {
	    ...
	    value: function createTab() {
	      var url = arguments.length <= 0 || arguments[0] === undefined ? "http://qiita.com" : arguments[0];
	    ...
	    value: function closeTab(index) {
	      ...
	      var nextCurrent = this.state.current;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.tabs.map(function (tab, index) {
	            return _react2.default.createElement(
	              'div',
	              { key: index,
	                className: index == _this4.state.current ? "tab-item active" : "tab-item",
	                onClick: function onClick() {
	                  _this4.setState({ current: index });
	                } },
	              _react2.default.createElement('span', { className: 'icon icon-cancel icon-close-tab', onClick: function onClick(e) {
	                  _this4.closeTab(index);
	                  e.stopPropagation();
	                  return false;
	                } }),
	              _this4.state.tabs[index].title
	            );
	          }),
	          _react2.default.createElement(
	            'div',
	            { className: 'tab-item tab-item-fixed', onClick: function onClick() {
	                _this4.createTab();
	              } },
	        ...
	        this.state.tabs.map(function (tab, index) {
	          return _react2.default.createElement(Tab, { key: index,
	            index: index,
	            url: tab.url,
	            visible: _this4.state.current == index,
	            updateTab: _this4.updateTab.bind(_this4),
	            createTab: _this4.createTab.bind(_this4) });
	        })
	      );
	    }
	  }]);
